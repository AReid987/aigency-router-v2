...
This project is indexed by GitNexus as **aigency-router-v2** (2396 symbols, 5884 relationships, 191 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/aigency-router-v2/process/{processName}` — trace the full execution flow step by step
